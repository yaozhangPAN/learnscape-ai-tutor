...
const Hero = () => {
  ...
  return (
    <div className="relative overflow-hidden bg-learnscape-cream">
      <div className="absolute inset-0 bg-gradient-to-b from-learnscape-yellow/30 to-white z-0"></div>
      
      {/* Decorative elements */}
      <div className="absolute top-20 left-10 w-10 h-10 rounded-full bg-learnscape-lime animate-bounce-slow opacity-70 hidden md:block"></div>
      <div className="absolute top-40 right-20 w-8 h-8 rounded-full bg-learnscape-blue animate-float opacity-70 hidden md:block"></div>
      <div className="absolute bottom-20 left-1/4 w-6 h-6 rounded-full bg-learnscape-lime animate-spin-slow opacity-70 hidden md:block"></div>
      <div className="absolute bottom-40 right-1/3 w-12 h-12 rounded-full bg-learnscape-blue animate-wiggle opacity-70 hidden md:block"></div>
        ...
        <div className="py-16 lg:py-24">
          <div className="lg:grid lg:grid-cols-12 lg:gap-8">
            <div className={`sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left transition-all duration-700 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
              ...
              <div className="mt-8 sm:flex sm:justify-center lg:justify-start">
                <div className="rounded-2xl shadow">
                  <Button asChild className="w-full flex items-center justify-center px-8 py-3 text-base font-medium bg-learnscape-blue hover:bg-sky-500 group rounded-2xl">
                    <Link to="/register">
                      Start Your Journey
                ...
                <div className="mt-3 sm:mt-0 sm:ml-3">
                  <Button asChild variant="yellow" className="w-full flex items-center justify-center px-8 py-3 text-base font-medium text-learnscape-darkBlue group rounded-2xl">
                    <Link to="/referral">
            ...
            <div className={`mt-12 relative sm:max-w-lg sm:mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-span-6 lg:flex lg:items-center transition-all duration-700 delay-200 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
              <div className="relative mx-auto w-full rounded-3xl shadow-lg lg:max-w-md">
                <div className="relative block w-full h-full bg-white rounded-3xl overflow-hidden border-2 border-gray-100">
                  <div className="p-8">
                    <Link to="/ai-tutor" className="block">
                      <div className="bg-white rounded-3xl shadow-md p-6 animate-float hover:animate-bounce-slow transition-all">
                        <div className="flex space-x-4 items-center mb-4">
                          <div className="w-12 h-12 rounded-full bg-gradient-to-r from-learnscape-blue to-learnscape-lime flex items-center justify-center animate-pulse">
                        ...
                        <div className="mt-4 text-sm text-gray-600 bg-green-50 p-3 rounded-2xl border border-green-100 relative">
