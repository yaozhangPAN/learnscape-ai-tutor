...
const SubscriptionBanner = ({ type, contentId }: SubscriptionBannerProps) => {
  ...
  if (loadingSubscription) {
    return (
      <div className="bg-gray-100 border-2 border-gray-200 p-4 rounded-lg animate-pulse">
  ...
  return (
    <div className="bg-gradient-to-r from-learnscape-blue/20 to-learnscape-purple/20 border-2 border-learnscape-blue/30 p-6 rounded-lg mb-6 shadow-md">
      <div className="flex items-start justify-between">
        ...
        <div className="bg-white p-3 rounded-lg shadow-md border-2 border-learnscape-blue/20">
