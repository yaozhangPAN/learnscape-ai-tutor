...
import OnlineClassroomSection from "./OnlineClassroomSection";
...
const mainBlocks = [
  ...
  },
  {
    ...
    bg: "bg-[#A48CF6]",
    text: "text-white",
    icon: <img src="/lovable-uploads/7a7e4714-d8d9-4f9c-acdc-a5e2aaae7344.png" alt="AI Tutor Icon" className="w-8 h-8 mr-2" />,
  ...
  },
  {
    ...
    bg: "bg-[#38B87D]",
    text: "text-white",
    icon: <img src="/lovable-uploads/02c00429-df63-4436-8a1b-a1a76314f56e.png" alt="Video Lessons Icon" className="w-8 h-8 mr-2" />,
  ...
  },
  {
    ...
    bg: "bg-[#19A69A]",
    text: "text-white",
    icon: <img src="/lovable-uploads/f0df06aa-0094-4ce2-9d9a-d7d749143aed.png" alt="Question Bank Icon" className="w-8 h-8 mr-2" />,
...
const MainBlocksGrid: React.FC = () => (
  <div className="grid grid-cols-2 grid-rows-4 gap-4 max-w-2xl w-full my-4 transition-all">
    ...
    {/* Streak and Progress and Leaderboard rendered from their own components in Index.tsx for clarity */}
  </div>
);

export default MainBlocksGrid;
