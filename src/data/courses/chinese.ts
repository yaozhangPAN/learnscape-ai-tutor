...
export const masterclassLesson3: Course = {
  id: "psle-chinese-masterclass-lesson3",
  title: "PSLE 华文名师课 - 第三课",
  description: "本系列第三课，由资深华文名师主讲，针对PSLE华文考试阅读理解和作文重点难点进行专项训练，助你提升成绩。",
  level: "p6",
  subject: "chinese",
  duration: "10 weeks",
  rating: 4.9,
...
export const masterclassLesson5: Course = {
  id: "psle-chinese-masterclass-lesson5",
  title: "PSLE 华文名师课 - 第五课",
  description: "本系列第五课，由资深华文名师主讲，针对PSLE华文考试阅读理解和作文重点难点进行专项训练，助你提升成绩。",
  level: "p6",
  subject: "chinese",
  duration: "10 weeks",
  rating: 4.9,
...
export const masterclassLesson6: Course = {
  id: "psle-chinese-masterclass-lesson6",
  title: "PSLE 华文名师课 - 第六课",
  description: "本系列第六课，由资深华文名师主讲，针对PSLE华文考试阅读理解和作文重点难点进行专项训练，助你提升成绩。",
  level: "p6",
  subject: "chinese",
  duration: "10 weeks",
  rating: 4.9,
