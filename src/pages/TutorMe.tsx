      ...
      <main className="flex-1 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
          <div className="mb-6">
            ...
            <h1 className="text-3xl font-bold text-learnscape-darkBlue">Tutor Me</h1>
            <p className="text-gray-600 mt-1">Get personalized help with any subject or concept you're struggling with.</p>
          </div>
