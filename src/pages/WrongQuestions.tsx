    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-learnscape-darkBlue text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold mb-4">Wrong Questions</h1>
          <p className="text-lg">Review and practice questions you got wrong</p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          {isLoading ? (
            ...
            <div className="text-center py-12">
              <h3 className="text-lg font-medium text-gray-900">No wrong questions yet</h3>
